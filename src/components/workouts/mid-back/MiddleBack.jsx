...
// import MiddleBack from '../MiddleBack/MiddleBack';
...
const MiddleBack = () => {
  ...
  const chestExercises = exercisesData.exercises.filter(
    exercise => exercise.primaryMuscles.includes('middle back')
  );  
  ...
  return (
    <div className="container mx-auto py-10 px-8">
      <h2 className="text-2xl font-bold mb-4">MiddleBack</h2>
      <div className="mb-4">
        {/* Search input */}
        <input
          type="text"
