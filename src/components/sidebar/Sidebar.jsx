...
export function SidebarItem({ icon, text, alert, linkTo }) {
  const { expanded, activeItem, handleItemClick } = useContext(SidebarContext);
  const isActive = activeItem === text;

  const handleClick = () => {
    handleItemClick(text); // Set the active item to the component's text
  };
  ...
  return (
    ...
    `}
      onClick={handleClick} // Use the handleClick function to set the active item
    >
